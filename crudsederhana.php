...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $fakultas) {
        if ($op == 'edit') { //untuk update
            $sql1       = "update tbmahasiswa set nim = '$nim',nama='$nama',alamat = '$alamat',fakultas='$fakultas' where id = '$id'";
            $q1         = mysqli_query($koneksi, $sql1);
            if ($q1) {
            ...
            $sql1   = "insert into tbmahasiswa(nim,nama,alamat,fakultas) values ('$nim','$nama','$alamat','$fakultas')";
            $q1     = mysqli_query($koneksi, $sql1);
            if ($q1) {
    ...
    <div class="mx-auto">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    header("refresh:5;url=crudsederhana.php");//5 : detik
                }
                ?>
                <?php
                if ($sukses) {
                ...
                <?php
                    header("refresh:5;url=crudsederhana.php");
                }
                ?>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fakultas" id="fakultas">
                                ...
                                <option value="Ilmu Administrasi" <?php if ($fakultas == "ilmu administrasi") echo "selected" ?>>Ilmu Administrasi</option>
                                ...
                                <option value="Pendidikan Vokasi" <?php if ($fakultas == "pendidikan vokasi") echo "selected" ?>>Pendidikan Vokasi</option>
                                <option value="MIPA" <?php if ($fakultas == "mipa") echo "selected" ?>>MIPA</option>
                                <option value="Ilmu Pengetahuan Budaya" <?php if ($fakultas == "ilmu pengetahuan budaya") echo "selected" ?>>Ilmu Pengetahuan Budata</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="crudsederhana.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning">Update</button></a>
                                    <a href="crudsederhana.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Apakah anda ingin menghapus data?')"><button type="button" class="btn btn-danger">Delete</button></a>            
                                </td>
                            </tr>
                        <?php
                        }
